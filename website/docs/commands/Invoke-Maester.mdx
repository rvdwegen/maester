...
Invoke-Maester [[-Path] <String>] [-Tag <String[]>] [-ExcludeTag <String[]>] [-OutputHtmlFile <String>]
 ...
 [-NonInteractive] [-SkipScopeCheck] [-PassThru] [-MailRecipient <String[]>] [-MailTestResultsUri <String>]
...
Skips checking the current graph connection for required scopes.
Can be used when your application has the reqiored access through different scopes.
